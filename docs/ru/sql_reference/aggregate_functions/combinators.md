...
Если агрегатная функция не имеет входных значений, то с помощью комбинатора `-OrDefault` функция возвращает значение по умолчанию для возвращаемого типа данных. Данный комбинатор применяется к агрегатным функциям, которые могут принимать пустые входные данные.
...
Этот комбинатор заменяет возвращаемое значение на нулевое, если агрегатная функция не имеет значений для вычисления. Данный комбинатор работает с различными агрегатными функциями.
`-OrNull` может использоваться с другиими комбинаторами.
...
Возвращает значение `Null` для возвращаемого типа агрегатной функции, если агрегировать нечего.
